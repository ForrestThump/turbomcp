...
//! token.
//!
//! An implementation (e.g. `turbomcp4_auth::ResourceServer`) validates the
//! request's `Authorization` header and either authorizes it — yielding a
//! serializable principal the dispatcher lifts into
//! [`RequestContext::identity`](turbomcp4_core::RequestContext) — or rejects it
...
pub enum AuthDecision {
    ...
    /// [`meta::internal::IDENTITY`](turbomcp4_core::meta::internal::IDENTITY)
