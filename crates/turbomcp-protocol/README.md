...
```toml
[dependencies]
turbomcp-protocol = { version = "3.1.2", features = ["experimental-tasks"] }
```
...
```toml
[dependencies]
turbomcp-protocol = "3.1.2"  # All core features included
```
...
**After (v3.0):**
```toml
turbomcp-protocol = "3.1.2"  # All features included by default
```
...
```toml
[dependencies]
turbomcp-protocol = { version = "3.1.2", features = ["simd", "zero-copy", "lock-free"] }
```

**Observable production build:**
```toml
[dependencies]
turbomcp-protocol = { version = "3.1.2", features = ["simd", "tracing", "metrics"] }
```
