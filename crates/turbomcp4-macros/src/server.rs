...
//!
//! All generated paths are rooted at `::turbomcp4` so the macro works from any
//! downstream crate.
...
pub(crate) fn expand(attr: TokenStream, item: TokenStream) -> syn::Result<TokenStream> {
    ...
    let entry_impl = quote! {
        impl #self_ty {
            ...
            pub fn into_server(self) -> ::turbomcp4::ServerBuilder<Self> {
                ::turbomcp4::ServerBuilder::new(self) #registrations
            }
...
fn gen_core_impl(self_ty: &Type, args: &ServerArgs) -> TokenStream {
    ...
    quote! {
        impl ::turbomcp4::McpServerCore for #self_ty {
            fn server_info(&self) -> ::turbomcp4::Implementation {
                #[allow(unused_mut)]
                let mut __info = ::turbomcp4::Implementation::new(#name, #version);
                #title_set
                __info
            }
            #instructions_fn
...
fn gen_tools_impl(self_ty: &Type, tools: &[Handler]) -> TokenStream {
    ...
    quote! {
        ...
        impl ::turbomcp4::WithTools for #self_ty {
            async fn list_tools(
                &self,
                _ctx: &::turbomcp4::ListToolsContext,
                _params: ::turbomcp4::neutral::ListParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::ListToolsResult> {
                ::core::result::Result::Ok(::turbomcp4::neutral::ListToolsResult::new(
            ...
            async fn call_tool(
                &self,
                ctx: &::turbomcp4::CallToolContext,
                params: ::turbomcp4::neutral::CallToolParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::CallToolResult> {
                match params.name.as_str() {
                    #(#call_arms)*
                    other => ::core::result::Result::Ok(
                        ::turbomcp4::neutral::CallToolResult::error(
...
fn gen_args_struct(t: &Handler) -> TokenStream {
    ...
    quote! {
        #[derive(
            ::turbomcp4::__macros::serde::Deserialize,
            ::turbomcp4::__macros::schemars::JsonSchema,
        )]
        #[serde(crate = "::turbomcp4::__macros::serde")]
        #[schemars(crate = "::turbomcp4::__macros::schemars")]
    ...
    quote! {
        {
            let mut __schema = ::turbomcp4::__macros::normalize_input_schema(
                ::turbomcp4::__macros::serde_json::to_value(
                    ::turbomcp4::__macros::schemars::schema_for!(#ident)
...
fn gen_tool_call_arm(t: &Handler) -> TokenStream {
    ...
    quote! {
        #name => {
            let __args: #ident = match ::turbomcp4::__macros::serde_json::from_value(
                ::turbomcp4::__macros::serde_json::Value::Object(params.arguments)
            ) {
            ...
            ::turbomcp4::IntoCallToolResult::into_call_tool_result(
...
fn gen_resources_impl(self_ty: &Type, resources: &[Handler]) -> TokenStream {
    let list_entries = resources.iter().map(|r| {
        ...
        let desc = r
            ...
            .as_ref()
            .map(|d| quote!(.with_description(#d)));
        quote!(::turbomcp4::neutral::Resource::new(#uri, #name) #desc)
    });
    let read_arms = resources.iter().map(|r| {
        ...
        quote! {
            #uri => ::turbomcp4::IntoReadResourceResult::into_read_resource_result(
                self.#method(#(#call_args),*).await,
                #uri,
            ),
        }
    ...
    quote! {
        impl ::turbomcp4::WithResources for #self_ty {
            async fn list_resources(
                &self,
                _ctx: &::turbomcp4::ListResourcesContext,
                _params: ::turbomcp4::neutral::ListParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::ListResourcesResult> {
                ::core::result::Result::Ok(::turbomcp4::neutral::ListResourcesResult::new(
                    ::std::vec![ #(#list_entries),* ],
                ))
            }
            ...
            async fn read_resource(
                &self,
                ctx: &::turbomcp4::ReadResourceContext,
                params: ::turbomcp4::neutral::ReadResourceParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::ReadResourceResult> {
                match params.uri.as_str() {
                    #(#read_arms)*
                    other => ::core::result::Result::Err(
                        ::turbomcp4::McpError::resource_not_found(other)
                    ),
                }
            }
        }
...
fn gen_prompts_impl(self_ty: &Type, prompts: &[Handler]) -> TokenStream {
    ...
    quote! {
        impl ::turbomcp4::WithPrompts for #self_ty {
            async fn list_prompts(
                &self,
                _ctx: &::turbomcp4::ListPromptsContext,
                _params: ::turbomcp4::neutral::ListParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::ListPromptsResult> {
                ::core::result::Result::Ok(::turbomcp4::neutral::ListPromptsResult::new(
                    ::std::vec![ #(#list_entries),* ],
                ))
            }
            ...
            async fn get_prompt(
                &self,
                ctx: &::turbomcp4::GetPromptContext,
                params: ::turbomcp4::neutral::GetPromptParams,
            ) -> ::turbomcp4::McpResult<::turbomcp4::neutral::GetPromptResult> {
                match params.name.as_str() {
                    #(#get_arms)*
                    other => ::core::result::Result::Err(
                        ::turbomcp4::McpError::invalid_params(
...
fn gen_prompt_list_entry(p: &Handler) -> TokenStream {
    ...
    let args = p.args.iter().map(|a| {
        ...
        let adesc = a
            ...
            .as_ref()
            .map(|d| quote!(.with_description(#d)));
        quote!(.with_argument(::turbomcp4::neutral::PromptArgument::new(#arg_name) #req #adesc))
    });
    quote!(::turbomcp4::neutral::Prompt::new(#name) #desc #(#args)*)
}
...
fn gen_prompt_get_arm(p: &Handler) -> TokenStream {
    ...
    quote! {
        #name => {
            #(#extracts)*
            ::turbomcp4::IntoGetPromptResult::into_get_prompt_result(
                self.#method(#(#call_args),*).await
            )
        }
    }
