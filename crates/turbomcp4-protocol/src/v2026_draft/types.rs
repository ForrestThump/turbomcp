...
//! Source schema path at generation time: /Users/nickpaterno/work/reference/modelcontextprotocol/schema/draft/schema.json
...
impl ::core::convert::TryFrom<&str> for ResultType {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::core::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::core::convert::TryFrom<&::alloc::string::String> for ResultType {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::alloc::string::String,
    ) -> ::core::result::Result<Self, self::error::ConversionError> {
