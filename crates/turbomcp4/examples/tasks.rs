...
//!
//! ```text
//! cargo run -p turbomcp4 --example tasks --features ext-tasks
//! ```

use std::sync::Arc;
use std::time::Duration;

use turbomcp4::ext_tasks::TasksExtension;
use turbomcp4::prelude::*;
use turbomcp4::{LegacySessionAdapter, ProtocolError, serve_stdio};
